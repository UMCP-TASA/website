...
export type RaisedImageFragment = { childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> };
...
export type BackgroundImageFragment = { childImageSharp?: Maybe<{ fluid?: Maybe<(
